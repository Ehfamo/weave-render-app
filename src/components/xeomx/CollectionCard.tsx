  ...
  return (
    ...
    >
      <div className="relative aspect-[16/10] overflow-hidden">
        ...
        <span className="absolute end-4 top-4 inline-flex items-center gap-1 rounded-full border border-border/60 bg-background/60 px-2 py-1 text-[10px] uppercase tracking-[0.2em] text-muted-foreground backdrop-blur">
