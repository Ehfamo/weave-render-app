  ...
  return (
    <div className="relative min-h-svh overflow-hidden bg-background">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div
          className="absolute -left-32 top-1/4 h-96 w-96 rotate-12 rounded-[3rem] opacity-20 blur-3xl"
          style={{ background: "var(--gradient-magenta)" }}
        />
        <div
          className="absolute right-0 top-0 h-72 w-72 -rotate-12 rounded-full opacity-20 blur-3xl"
      ...
      <div className="relative mx-auto flex max-w-3xl flex-col gap-10 px-4 py-10 sm:px-8 sm:py-20">
        ...
        <div>
          ...
          <div className="relative mt-3 aspect-[16/9] overflow-hidden rounded-3xl border border-white/10">
            <div
              ...
              style={{
                background:
                  "conic-gradient(from 90deg at 50% 50%, oklch(0.81 0.13 80 / 0.35), oklch(0.68 0.28 0 / 0.35), oklch(0.81 0.13 80 / 0.35))",
              }}
            />
            <div className="absolute inset-0 backdrop-blur-2xl" />
            <div className="relative grid h-full place-items-center">
              <div className="font-display text-2xl italic text-foreground/60">
                {m.vision_glimpse()}
              </div>
            </div>
          </div>
        ...
        <div className="rounded-3xl border border-white/10 bg-surface/40 p-6 backdrop-blur">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            {m.vision_future_desc({ name: section.name })}
          </p>
          <div className="mt-4">
            <NotifyForm sectionSlug={section.slug} />
          </div>
        </div>
      </div>
    </div>
