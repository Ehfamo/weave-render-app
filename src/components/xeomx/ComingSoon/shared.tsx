...
export function BackToExplore() {
  return (
    <Link
      to="/explore"
      className="inline-flex items-center gap-2 rounded-full border border-border bg-surface/60 px-3 py-1.5 text-xs text-foreground backdrop-blur transition hover:border-amber-300/40"
    >
