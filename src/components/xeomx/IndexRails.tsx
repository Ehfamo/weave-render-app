    ...
    <>
      ...
      <section className="px-4 sm:px-8">
        <div className="mb-6 flex items-end justify-between">
          <div>
            ...
            <h2 className="mt-1 font-display text-3xl font-semibold tracking-tight sm:text-4xl">
              {m.creators_title_1()}{" "}
              <span className="text-gradient-magenta">{m.creators_title_2()}</span>
            </h2>
          </div>
          <Link
            to="/creators"
                ...
                <div className="absolute end-3 top-3 flex flex-col gap-2">
                  {[
                    ...
                    <span
                      ...
                      aria-label={label}
                      role="img"
                      className="grid h-10 w-10 place-items-center rounded-full border border-foreground/20 bg-background/40 backdrop-blur transition hover:border-magenta/60"
                    >
      ...
      <section className="relative mx-4 overflow-hidden rounded-3xl border border-border sm:mx-8">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(120deg, oklch(0.13 0.012 40 / 0.9), oklch(0.13 0.012 40 / 0.4))",
          }}
        />
