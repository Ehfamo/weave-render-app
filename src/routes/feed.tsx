...
function Feed() {
  ...
  return (
    <div className="relative bg-background">
      <Link
        to="/"
        className="fixed left-4 top-4 z-30 inline-flex items-center gap-2 rounded-full border border-border bg-background/60 px-3 py-1.5 text-xs text-foreground backdrop-blur transition hover:border-magenta/40 sm:left-6 sm:top-6"
      >
