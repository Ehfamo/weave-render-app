...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: m.terms_head_title() },
      { name: "description", content: m.terms_head_desc() },
      { property: "og:title", content: m.terms_head_title() },
      { property: "og:description", content: m.terms_head_desc() },
    ],
  }),
  component: TermsPage,
});
  ...
  return (
    <div className="min-h-svh bg-background">
      ...
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-8 sm:py-24">
        ...
        <h1 className="font-display text-4xl font-bold tracking-tight sm:text-5xl">{m.terms_title()}</h1>
